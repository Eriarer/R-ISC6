...
png("dadosNoTransitivos.png", res = 100)
par(mfrow = c(1, 3))
barplot(t1vs2, main = "Red vs Blue", col = names(t1vs2), ylab = "Frecuencia", xlab = "Ganador p/ tirada",
        names.arg = names(t1vs2))
barplot(t1vs3, main = "Red vs Green", col = names(t1vs3), ylab = "Frecuencia", xlab = "Ganador p/ tirada",
...
# Preparar la pantalla para guardar 3 gráficos, lo que salga a la pantalla guardarlo en un archivo png
png("dadosNoTransitivos_2Tiradas.png", res = 100)
par(mfrow = c(1, 3))
...
dado2 <- dado(c(3, 3, 3, 3, 3, 3), "green")
dado3 <- dado(c(6, 6, 2, 2, 2, 2), "blue")
...
png("dadosNoTransitivosEfron.png", res = 100)
par(mfrow = c(2, 3))
barplot(t1vs2, main = "Red vs Blue", col = names(t1vs2), ylab = "Frecuencia", xlab = "Ganador p/ tirada",
        names.arg = names(t1vs2))
barplot(t1vs3, main = "Red vs Green", col = names(t1vs3), ylab = "Frecuencia", xlab = "Ganador p/ tirada",
